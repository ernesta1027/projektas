    ...
    <div class="container-login100">
      <div class="wrap-login100">
        <form class="login100-form validate-form" action="" method="POST">
          <span class="login100-form-title p-b-43" style="color: white"> Darbuotojų prisijungimas </span>
          
          <p><?php echo check_message()?>;</p>
          <div class="wrap-input100 validate-input" data-validate = "Valid mail is required: ex@abc.xyz">
            <input class="input100" type="text" name="user_email">
            <span class="focus-input100"></span>
            <span class="label-input100">Prisijungimo vardas</span>
          </div>
          ...
          <div class="wrap-input100 validate-input" data-validate="Password is required">
            ...
            <span class="focus-input100"></span>
            <span class="label-input100">Slaptažodis</span>
          </div>
          ...
          <div class="container-login100-form-btn">
            <button class="login100-form-btn" type="submit" name="btnLogin" style="background-color: green">
              Prisijungti
            </button>
          </div>
          ...
          <div class="text-center p-t-46 p-b-20">
            <span class="txt2">
               <a href="../index.php"><i class="fa fa-arrow-left"></i> Grįžti atgal</a>
            </span> 
          </div>
<!-- 
