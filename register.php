...
<section id="title-header">
 ...
 <div class="container" style="min-height: 500px;">  
      <p class="page-header" style="font-size: 30px;">Registracija</p>
      <?php check_message(); ?>
    <div id="login-dp">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <div class="col-md-9">
                      <label class="col-md-4 control-label" for=
                      "USERNAME">Vartotojo vardas:</label>
                 ...
                 <div class="form-group">
                    <div class="col-md-9">
                      ...
                      <div class="col-md-8">
                        <button type="submit" name="btnRegister" class="btn btn-primary btn-sm" style="background-color: #BDB76B">Registruotis</button>
                        <a href="login.php"><i class="fa fa-arrow-left"></i> Prisijungti</a>
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: #BDB76B; color:#fff;">
